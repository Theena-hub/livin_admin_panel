...
// for subcatgory
$query = "SELECT * FROM tbl_customize_subcategory WHERE status = 1";
...
<body class="  ">
    ...
    <main class="main-content">
        ...
        <div id="overlay">
            <div id="popup">
                <h5 class="text-center fw-600 text-primary text-uppercase mb-2">Add Customize Sub Category</h5>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#subcategoryForm").submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'backend-customize-subcategory',
                    data: formData,
                    contentType: false,
                    processData: false,
