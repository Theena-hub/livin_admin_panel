...
class SiteSubCategory
{
    function add()
    {
        ...
        $queryCategory = "SELECT name FROM tbl_site_category WHERE id = '$categoryId'";
        ...
        if (isset($_FILES['image']) && $_FILES['image']['error'] == UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($image_tmp_name, $target_path)) {
                ...
                $query = "INSERT INTO tbl_site_subcategory (category_id,category_name,name,image) VALUES ('$categoryId','$categoryName','$subcategoryName','$image_name')";
            ...
            echo json_encode(['success' => false, 'message' => 'Sub Category Image is Empty!']);
        }        
    }
    function delete()
    {
        ...
        $query = "UPDATE tbl_site_subcategory SET status = 0 WHERE id = '$id'";
        $result = mysqli_query($conn, $query);
